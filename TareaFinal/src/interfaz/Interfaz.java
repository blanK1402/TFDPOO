...
public class Interfaz extends JFrame {
	...
	public Interfaz() {
		...
		String[] columnNamesPasajero = {"Carné de Identidad", "Nombre"};
		...
		String[] columnNamesConductor = {"Nombre", "Carné", "Categoría", "Años de Experiencia", "Licencia"};
		...
		String[] columnasViaje = {"Fecha/Hora Partida", "Destino", "Fecha Llegada", "Ómnibus", "Conductor", "Precio"};
		...
		String[] columnNamesReserva = {"Nombre Pasajero", "Carné", "Nro Reservación", "Destino", "Fecha Reservación", "Fecha Viaje", "Importe"};
		Object[][] dataReserva = {};
	...
	public void crearViaje(DefaultTableModel modelViaje) {
	    VentanaViaje ventanaViaje = new VentanaViaje(Interfaz.this, terminal.getOmnibus(), terminal.getConductores(), terminal.getFechaHora());
