...
public class Interfaz extends JFrame {
	...
	public Interfaz(final Terminal terminal) {
		...
		nombrePasajero.setFont(new Font("Microsoft JhengHei UI", Font.PLAIN, 15));
		...
		final JComboBox<String> destinoViaje = new JComboBox<String>();
		...
		btnImportarDatos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					ArrayList<Pasajero> pasajeros = Runner.generarPasajeros(terminal.getPasajeros(), terminal.getNombresList());
					...
					ArrayList<Viaje> viajes = Runner.generarViajes(20, terminal.getDestinosDistancias(), terminal, conductores, omnibuses);
		...
		btnCrear_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					Pasajero p = new Pasajero(nombrePasajero.getText(), idPasajero.getText());
